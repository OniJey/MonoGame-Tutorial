...
internal class AnimatedButton : Button
{
    ...
    public AnimatedButton(TextureAtlas atlas)
    {
        ...
        {
            TopCoordinate = unfocusedTextureRegion.NormalizedTop,
            BottomCoordinate = unfocusedTextureRegion.NormalizedBottom,
            LeftCoordinate = unfocusedTextureRegion.NormalizedLeft,
            RightCoordinate = unfocusedTextureRegion.NormalizedRight,
            FrameLength = 0.3f,
        ...
        foreach (TextureRegion region in focusedAtlasAnimation.Frames)
        {
            ...
            {
                TopCoordinate = region.NormalizedTop,
                BottomCoordinate = region.NormalizedBottom,
                LeftCoordinate = region.NormalizedLeft,
                RightCoordinate = region.NormalizedRight,
                FrameLength = (float)focusedAtlasAnimation.Frametime.TotalSeconds,
